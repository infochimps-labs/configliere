...
Configliere understands Integer, Float, :boolean, Symbol, Array, Date, Time and DateTime. (Make sure to call Settings.resolve! in your script.)

Array just does a simple split on ",". It doesn't do any escaping or quoting.

<pre>
    Settings.define :groceries, :type => Array
    Settings :groceries => 'apples,honey,walnuts'
    Settings.resolve!
    Settings[:groceries]   #=> ['apples', 'honey', 'walnuts']
</pre>
...
All of the above uses the global variable @Settings@, defined in configliere.rb.  You're free to define your own settings universe though:
